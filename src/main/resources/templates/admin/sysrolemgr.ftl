...
<div id="delModal" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="delSysRole" method="post">
        <input type="hidden" id="sysRoleId" name="id">
...
<div id="addModal" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="addSysRole" method="post">
        <div class="modal-header">
          <h4 id="addModalLabel" class="modal-title">添加角色</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>
        </div>
        <div class="modal-body">
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-2 col-form-label">角色名称</label>
            <div class="col-sm-10">
...
<div id="editModal" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="updSysRole" method="post">
...
<script>
  ...
  $(function () {
    $("#dataTable").dataTable({
      ...
      sAjaxSource: "sysRoleListPage", //服务端请求数据接口
      ...
      aoColumns: [
        ...
        {"data": "roleName"},
        {
          ...
          'render': function (data, type, row) {
            let id = row.id;
            let optdom = "<a class='btn btn-primary' onclick='editSysRole(" + id + ")'    data-toggle='modal' > " +
                    "<i class='fas fa-edit' ></i> 编辑</a>" +
                    "<a class='btn btn-danger ' onclick='delSysRole("+id+")' data-toggle='modal' >" +
